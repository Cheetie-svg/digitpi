...
export default function SupportJoinPage() {
      ...
      <div className="min-h-screen bg-[#F0F4F3] flex items-center justify-center p-6">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-sm p-8 text-center">
          ...
          <p className="text-sm text-[#6B7A79] mt-3 leading-relaxed">
            Your Support agent application has been submitted. Admin will review
            and activate access. Typical review: 5–7 working days.
          </p>
          <Link href="/login">
  ...
  return (
    <div className="min-h-screen bg-[#F0F4F3] flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-sm p-8">
        ...
        <h1 className="text-2xl font-bold text-[#142A2E] mt-1">Support agent registration</h1>
        <p className="text-sm text-[#6B7A79] mt-2">
          Only people given this link by Admin should register here.
        </p>

        <div className="mt-6 space-y-3">
          <div>
            <p className="text-xs text-[#8B9998] uppercase mb-1">Full name</p>
            <input
              value={fullName}
          ...
          >
            {loading ? "Submitting..." : "Submit Support application"}
          </button>
        </div>
      </div>
    </div>
