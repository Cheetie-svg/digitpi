          ...
          <div className="bg-[#EEF2F1] rounded-[2rem] overflow-hidden min-h-[620px] flex flex-col px-6 py-8">
            <div className="flex-1 flex flex-col items-center justify-center text-center">
              ...
              <p className="text-[13px] text-[#6B7A79] mt-4 leading-relaxed">
                Your partnership request has been submitted to DIGITπ.
              </p>
              <p className="text-[13px] text-[#6B7A79] mt-3 leading-relaxed">
                We only approve partners such as water companies after a direct
                review. You will be contacted if your application is accepted.
              </p>
        ...
        <div className="bg-[#EEF2F1] rounded-[2rem] overflow-hidden min-h-[620px] flex flex-col">
          ...
          <div className="px-5 pt-6 pb-3">
            ...
            <p className="text-[12px] text-[#6B7A79] mt-1">
              For water companies and approved organisations
            </p>
          </div>
          ...
          <div className="flex-1 overflow-y-auto px-5 space-y-3 pb-4">
            <div className="bg-white rounded-xl p-4 shadow-sm text-[13px] text-[#142A2E] leading-relaxed space-y-2">
              ...
              <p>• Official water utility or authorised organisation</p>
              <p>• Ability to issue referral codes to customers</p>
              <p>• Agree to DIGITπ partner commission rules</p>
              <p>• Application reviewed and approved by Admin only</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-4 shadow-sm text-[13px] text-[#6B7A79] leading-relaxed">
              ...
              Admin will review your application. Random public signups are not
              accepted. Once approved, you receive a referral code and partner dashboard.
            </div>
