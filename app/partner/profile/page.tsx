      ...
      <div className="w-full max-w-sm bg-[#142A2E] rounded-[2.5rem] p-2.5 shadow-2xl">
        <div className="bg-[#EEF2F1] rounded-[2rem] overflow-hidden min-h-[620px] flex flex-col">
          ...
          <div className="px-5 pt-6 pb-3">
            <h1 className="text-[16px] font-bold text-[#142A2E]">Partner Profile</h1>
          </div>
          ...
          <div className="flex flex-col items-center mt-4 px-6">
            ...
            <h2 className="text-[17px] font-semibold text-[#142A2E] mt-3">Partner</h2>
            <p className="text-[13px] text-[#6B7A79]">Referral Partner Account</p>
          </div>
          ...
          <div className="mt-6 px-5 space-y-2 flex-1 overflow-y-auto pb-4">
            ...
            <div className="bg-white rounded-xl px-4 py-3 shadow-sm">
              <p className="text-[11px] text-[#8B9998] uppercase">Organisation / Name</p>
            ...
            <div className="bg-[#0F6E76] rounded-xl px-4 py-4 mt-2">
              ...
              <p className="text-2xl font-bold text-white mt-1 tracking-wider">PARTNER001</p>
              <p className="text-[11px] text-[#BFE0DD] mt-2">
                Share this code. You earn from every purchase made by users who sign up with it.
              </p>
            </div>

            <div className="bg-white rounded-xl px-4 py-3.5 flex items-center justify-between shadow-sm mt-2">
              <span className="text-[13px] text-[#142A2E]">Help & Support</span>
              <span className="text-[#8B9998]">›</span>
            </div>

            <Link href="/" className="bg-white rounded-xl px-4 py-3.5 flex items-center justify-between shadow-sm">
